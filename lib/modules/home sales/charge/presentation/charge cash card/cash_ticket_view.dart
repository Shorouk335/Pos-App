...
class CashTicketView extends StatefulWidget {
  const CashTicketView({super.key, required this.chargePriceTicketModel});
  final ChargePriceTicketPageModel chargePriceTicketModel;

  @override
  State<CashTicketView> createState() => _CashTicketViewState();
}

class _CashTicketViewState extends State<CashTicketView> {
  @override
                      ...
                      Column(
                        ...
                        children: [
                          CustomText(context: context,
                            text:
                                "EGP ${widget.chargePriceTicketModel.currentPrice}",
                            size: 30.0,
                          ),
                          CustomText(context: context,
                            text: "total-paid".tr(),
                ...
                BlocBuilder<SalesCubit, SalesStates>(
                  builder: (context, state) {
                    return CustomButton(
                      ...
                      text: widget.chargePriceTicketModel.isSplitCycle
                          ? "continue".tr()
                          : "new_sale".tr(),
                      icon: Icons.check,
                      height: 50.0,
